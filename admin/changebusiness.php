    ...
    <div class="container">
      ...
      <h2>Change Family Group of the user</h2><hr>
       ...
       <?php 
         ...
         <?php 
            if (!isset($_GET['businessid']) || $_GET['businessid'] == NULL) {
                echo "<script>window.location='catlist.php';</script>";
            }else{
         ...
         <form action="" method="post">
                        <table class="form">                    
                             ...
                             <tr>
                                <td>
                                    <label class="form-group">Business Name :</label>
                                </td>
                                <td>
            ...
            ?>
                                        <option value="<?php echo $result['id']; ?>" <?php if($result['id']==$businessid){echo 'selected';} ?>><?php echo $result['name']; ?></option> <?php } } ?>
